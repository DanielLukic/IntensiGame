...
IntensiGame is a simple framework with a 'game engine' at its core. This engine knows how to render 'frames' and keep track of time and issue the proper number of 'control ticks'.
